...
from PYfunctions.statistics.calc_PDF import PDF
...
plt.plot(np.arange(1,6,1/365) ,RCEr-np.mean(RCEr),'k',linewidth=1, label= 'RC imbalance')
plt.plot(np.arange(1,6,1/365) ,cvr-np.mean(cvr),'r',linewidth=1, label= 'Convection heating')
plt.plot(np.arange(1,6,1/365) ,prr-np.mean(prr),'r--',linewidth=.8, label= 'Precipitation')
plt.plot(np.arange(1,6,1/365) ,Radr-np.mean(Radr),'b',linewidth=1, label= 'Radiative cooling')
ax=plt.gca()
ax.set_xlim(1, 6)
ax.set_ylim(-20, 30)
plt.legend(loc='upper right', fontsize=8)
picsave= '/data/cloud/Goldtimes5/pic/GCM_SPCAM/RCE/TimeSeries/RCE_decomp_5yr.png'
#plt.savefig(picsave)
#plt.show()
...
plt.plot(np.arange(1,5*365+1,1) ,RCEr-np.mean(RCEr),'k',linewidth=1, label= 'RC imbalance')
plt.plot(np.arange(1,5*365+1,1) ,cvr-np.mean(cvr),'r',linewidth=1, label= 'Convection heating')
plt.plot(np.arange(1,5*365+1,1) ,prr-np.mean(prr),'r--',linewidth=.8, label= 'Precipitation')
plt.plot(np.arange(1,5*365+1,1) ,Radr-np.mean(Radr),'b',linewidth=1, label= 'Radiative cooling')
ax=plt.gca()
ax.set_xlim(1, 366)
ax.set_ylim(-20, 30)
plt.legend(loc='upper right', fontsize=8)
picsave= '/data/cloud/Goldtimes5/pic/GCM_SPCAM/RCE/TimeSeries/RCE_decomp_1yr.png'
#plt.savefig(picsave)
#plt.show()
...
plt.figure(figsize=(8,3))
plt.plot(np.arange(1,5*365+1,1) ,np.zeros(RCEr.size),'k',linewidth=0.5)
plt.plot(np.arange(1,5*365+1,1) ,prr-np.mean(prr),'r-',linewidth=1, label= 'Precipitation')
plt.plot(np.arange(1,5*365+1,1) ,CRMP-np.mean(CRMP),'k-',linewidth=1, label= 'Precipitation (CRM region)')
ax=plt.gca()
ax.set_xlim(1, 366)
ax.set_ylim(-20, 30)
plt.legend(loc='upper right', fontsize=8)
picsave= '/data/cloud/Goldtimes5/pic/GCM_SPCAM/RCE/TimeSeries/PRECT_CRM_region.png'
plt.savefig(picsave)
plt.show()
...
plt.figure(figsize=(8,3))
#plt.plot(np.arange(1,5*365+1,1) ,np.zeros(RCEr.size),'k',linewidth=0.5)
plt.plot(np.arange(1,5*365+1,1) ,prr,'r-',linewidth=1, label= 'Precipitation')
plt.plot(np.arange(1,5*365+1,1) ,CRMP,'k-',linewidth=1, label= 'Precipitation (CRM region)')
ax=plt.gca()
ax.set_xlim(1, 366)
#ax.set_ylim(-20, 30)
plt.legend(loc='upper right', fontsize=8)
picsave= '/data/cloud/Goldtimes5/pic/GCM_SPCAM/RCE/TimeSeries/PRECT_CRM_region_ori.png'
plt.savefig(picsave)
plt.show()
...
plt.figure(figsize=(8,3))
plt.plot(np.arange(1,5*365+1,1) ,np.zeros(RCEr.size),'k',linewidth=0.5)
h1= plt.plot(np.arange(1,5*365+1,1) ,Radr-np.mean(Radr),'b',linewidth=2, label= 'Radiative cooling')
h2= plt.plot(np.arange(1,5*365+1,1) ,(SWtr-np.mean(SWtr))/5,'r',linewidth=1,label= 'SW (TOA)/5')
h3= plt.plot(np.arange(1,5*365+1,1) ,-(SWsr-np.mean(SWsr))/5,'r--',linewidth=1,label= 'SW (sur)/5')
h4= plt.plot(np.arange(1,5*365+1,1) ,-(LWtr-np.mean(LWtr)),'k',linewidth=1,label= 'LW (TOA)')
h5= plt.plot(np.arange(1,5*365+1,1) ,LWsr-np.mean(LWsr),'k--',linewidth=1,label= 'LW (sur)')
ax=plt.gca()
ax.set_xlim(1, 366)
ax.set_ylim(-10, 20)
plt.legend(loc='upper right', fontsize=8)
picsave= '/data/cloud/Goldtimes5/pic/GCM_SPCAM/RCE/TimeSeries/Rad_decomp.png'
plt.savefig(picsave)
plt.show()
